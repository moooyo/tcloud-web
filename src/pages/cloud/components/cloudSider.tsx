...
const formatPageUrl = (
  ...
  switch (type) {
    case 'all':
      ...
      break;
    case 'doc':
      typeNumber = FileListType.Doc;
      break;
    case 'picture':
      typeNumber = FileListType.Image;
      break;
    case 'music':
      typeNumber = FileListType.Music;
      break;
    case 'video':
      typeNumber = FileListType.Video;
      break;
    case 'other':
      typeNumber = FileListType.Other;
      break;
    default:
      typeNumber = 0;
  }
  ...
  render() {
    return (
      <div className={style.sider}>
        <Menu mode={'inline'} onClick={this.onMenuClick}>
          <SubMenu
            key={'file'}
            title={
              <span>
